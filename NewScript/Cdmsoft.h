...
#import "C:\\MyGame\\dmyb.dll" no_namespace
// Cdmsoft 包装类
...
public:
	...
	long EnableShareDict(long en)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x16e, DISPATCH_METHOD, VT_I4, (void*)&result, parms, en);
		return result;
	}
	long DisableCloseDisplayAndSleep()
	{
		long result;
		InvokeHelper(0x16f, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	long Int64ToInt32(__int64 v)
	{
		...
		InvokeHelper(0x170, DISPATCH_METHOD, VT_I4, (void*)&result, parms, v);
		return result;
	}
	long GetLocale()
	{
	...
	{
		long result;
		InvokeHelper(0x172, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	long ReadDataToBin(long hwnd, LPCTSTR addr, long len)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_BSTR VTS_I4 ;
		InvokeHelper(0x173, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, addr, len);
		return result;
	}
	long WriteDataFromBin(long hwnd, LPCTSTR addr, long data, long len)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_BSTR VTS_I4 VTS_I4 ;
		InvokeHelper(0x174, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, addr, data, len);
		return result;
	}
	long ReadDataAddrToBin(long hwnd, __int64 addr, long len)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I8 VTS_I4 ;
		InvokeHelper(0x175, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, addr, len);
		return result;
	}
	long WriteDataAddrFromBin(long hwnd, __int64 addr, long data, long len)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I8 VTS_I4 VTS_I4 ;
		InvokeHelper(0x176, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, addr, data, len);
		return result;
	}
	...
	long SetDisplayRefreshDelay(long t)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x179, DISPATCH_METHOD, VT_I4, (void*)&result, parms, t);
		return result;
	}
	long IsFolderExist(LPCTSTR folder)
	{
		long result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x17a, DISPATCH_METHOD, VT_I4, (void*)&result, parms, folder);
		return result;
	}
	long GetCpuType()
	{
